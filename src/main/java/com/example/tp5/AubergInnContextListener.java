...
public class AubergInnContextListener implements ServletContextListener
{
    public void contextInitialized(ServletContextEvent sce)
    {
        System.out.println("Contexte de AubergInn WEB démarré : " + sce.getServletContext().getServletContextName());
    ...
    {
        System.out.println("Le contexte de l'application AubergInn vient d'être détruit.");
    }
}